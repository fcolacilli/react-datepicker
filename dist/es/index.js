...
import x from "date-fns/setYear";
import O from "date-fns/min";
import Y from "date-fns/max";
import I from "date-fns/differenceInCalendarDays";
import T from "date-fns/differenceInCalendarMonths";
...
import W from "date-fns/endOfDay";
  ...
  St = (function (t) {
    ...
    function n() {
      ...
      return (
        ...
        le(fe(t), "renderSelectOptions", function () {
          for (
            var r = Te(t.props.minDate), n = Te(t.props.maxDate), o = [];
            !U(r, n);
      ...
      return (
        ...
        le(fe(r), "getClassNames", function (e) {
          ...
          return t(
            ...
            n,
            "react-datepicker__day--" + Oe(r.props.day),
            {
    ...
    function n() {
      ...
      return (
        ...
        le(fe(t), "formatWeekNumber", function (e) {
          return t.props.formatWeekNumber ? t.props.formatWeekNumber(e) : xe(e);
        }),
        le(fe(t), "renderDays", function () {
          var r = Ie(t.props.day, t.props.locale, t.props.calendarStartDay),
            n = [],
    ...
    function o() {
      ...
      return (
        ...
        le(fe(r), "renderWeeks", function () {
          for (
            var t = [],
              ...
              o = 0,
              a = !1,
              s = Ie(Te(r.props.day), r.props.locale, r.props.calendarStartDay);
            t.push(
              e.createElement(Pt, {
        ...
        le(fe(r), "onMonthClick", function (e, t) {
          r.handleDayClick(Te(E(r.props.day, t)), e);
        }),
    ...
    function o(r) {
      ...
      return (
        ...
        le(fe(a), "isKeyboardSelected", function (e) {
          var t = Le(x(a.props.date, e));
          return (
            !a.props.disabledKeyboardNavigation &&
            !a.props.inline &&
            !Be(t, Le(a.props.selected)) &&
            Be(t, Le(a.props.preSelection))
          );
        }),
        le(fe(a), "onYearClick", function (e, t) {
          var r = a.props.date;
          a.handleYearClick(Le(x(r, t)), e);
        }),
        ...
        le(fe(a), "header", function () {
          var r =
              arguments.length > 0 && void 0 !== arguments[0]
                ? arguments[0]
                : a.state.date,
            n = Ie(r, a.props.locale, a.props.calendarStartDay),
            o = [];
          return (
          ...
          if (!a.props.renderCustomHeader) {
            ...
            if (
              ...
              var o =
                  ...
                  a.props.showYearPicker,
                s = a.props,
                p = s.previousMonthButtonLabel,
                i = s.previousYearButtonLabel,
                c = a.props,
          ...
          if (!a.props.renderCustomHeader) {
            ...
            if (
              ...
              var o =
                  ...
                  a.props.showYearPicker,
                s = a.props,
                p = s.nextMonthButtonLabel,
                i = s.nextYearButtonLabel,
                c = a.props,
                d = c.nextMonthAriaLabel,
                u =
                  void 0 === d ? ("string" == typeof p ? p : "Next Month") : d,
                h = c.nextYearAriaLabel,
                m = void 0 === h ? ("string" == typeof i ? i : "Next Year") : h;
              return e.createElement(
                "button",
                {
                  type: "button",
      ...
      return (
        ...
        le(fe(s), "handleChange", function () {
          ...
          if (
            ...
            s.setState({ inputValue: n.target.value, lastPreSelectChange: Wt });
            var o = _e(
              n.target.value,
              s.props.dateFormat,
              s.props.locale,
        ...
        le(fe(s), "setSelected", function (e, t, r, n) {
          ...
          if (null === o || !Ge(o, s.props)) {
            var a = s.props,
              ...
              c = a.startDate,
              l = a.endDate;
            if (!We(s.props.selected, o) || s.props.allowSameDay || i)
              if (
                (null !== o &&
                  (!s.props.selected ||
                    (r &&
